...
class BubbleClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    final Path path = Path()
      ...
      ..arcToPoint(Offset(leftPadding + radius, 0),
          radius: Radius.circular(radius))
      // end top left

      // start top right
      ..lineTo(size.width - radius - rightPadding, 0)
      ..arcToPoint(Offset(size.width - rightPadding, radius),
          radius: Radius.circular(radius))
      // end top right

      // start bottom right
      ..lineTo(size.width - rightPadding, size.height - radius)
      ..arcToPoint(Offset(size.width - rightPadding - radius, size.height),
          radius: Radius.circular(radius))
      ...
      ..arcToPoint(Offset(leftPadding, size.height - radius),
          radius: Radius.circular(radius))
      // end bottom left
