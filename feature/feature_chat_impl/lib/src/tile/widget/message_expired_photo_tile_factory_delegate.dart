...
import 'package:feature_chat_impl/src/tile/model/message_expired_photo_tile_model.dart';
...
class MessageExpiredPhotoTileFactoryDelegate
  ...
  @override
  Widget create(BuildContext context, MessageExpiredPhotoTileModel model) {
